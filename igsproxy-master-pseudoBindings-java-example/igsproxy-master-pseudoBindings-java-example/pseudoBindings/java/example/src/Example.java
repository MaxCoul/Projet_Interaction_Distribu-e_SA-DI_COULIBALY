...
public class Example implements AgentEventListener, WebSocketEventListener {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		a.definition.setDescription("java test agent 1");
		a.definition.setPackage("pseudoBindings");
		a.definition.setClass("agent_java_example1");
		...
		a2.definition.setPackage("pseudoBindings");
		a2.definition.setClass("agent_java_example2");
