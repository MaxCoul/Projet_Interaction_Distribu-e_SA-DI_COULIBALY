...
public class JavaTest1CB implements IopListener, ServiceListener {
	private static Logger _logger = LoggerFactory.getLogger(JavaTest1CB.class);
	...
	public void handleIOP(Agent agent, Iop iop, String name, IopType type, Object value) {
		...
		if (iop == Iop.IGS_INPUT_T && type == IopType.IGS_DATA_T) {
			...
			Path pathToFile = Paths.get("/Users/aurelien/Desktop/mydata1.png");
			try {
