...
url_image = "http://192.168.186.208:8080/stream.mjpeg?clientId=B5VYIFnf29rOucTs" #Url de recuperation du retour video de l application 
url_list = "list" #Url de recuperation des angles et distances  necessaires a la reconnnaissance de geste
n = 0 
current_pose = 0
...
#Fonction de comparaison de la liste de caracteristiques de la posture affichee avec celle de l'utilisaeur (reçue du serveur)
...
#Fonction de formation des listes de caracteristiques de la posture a partir des donnees recueillies.
...
#Fonction de recuperation du flux video de l application sur un url 
    ...
    try: 
        while True:
            ...
            if test:
                ...
                #displayimage(image_pose[current_pose], (150,150), ratio=1, image_type=1)  ligne pour changer de pose a l'ecran
...
#Fonction d affichage des images sur le whiteboard 
...
#Fonction de recuperation des valeurs envoyeees depuis le socket 
def get_landmarks():
...
if __name__ == "__main__":
    ...
    #displayimage(image_pose[0], (150,150), ratio=1, image_type=1)
